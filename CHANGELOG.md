...
- [#121](https://github.com/numbata/grape-oas/pull/121): Fix OAS 3.0 nullable object refs to use an `anyOf` null union instead of an ineffective `allOf` + `nullable: true` wrapper - [@numbata](https://github.com/numbata).
