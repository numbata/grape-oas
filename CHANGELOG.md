...
- [#152](https://github.com/numbata/grape-oas/pull/152): Keep OAS 2.0 non-body parameters spec-valid by dropping unsupported object, file, and composed schemas with a warning - [@numbata](https://github.com/numbata).
