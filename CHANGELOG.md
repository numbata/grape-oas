...
- [#45](https://github.com/numbata/grape-oas/pull/45): Fix `is_array: true` in request param documentation being ignored for primitive types — only entity types were wrapped in array schema - [@numbata](https://github.com/numbata).
