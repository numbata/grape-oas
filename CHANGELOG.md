...
- [#100](https://github.com/numbata/grape-oas/pull/100): Fix enum coercion under TYPE_ARRAY nullable strategy and stop nil enum members from being silently coerced to `0`/`0.0`/`false` across all nullable strategies and OAS versions (2.0, 3.0, 3.1) - [@numbata](https://github.com/numbata).
