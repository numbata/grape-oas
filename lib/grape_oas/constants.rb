...
module GrapeOAS
  ...
  module Constants
    ...
    # unbounded (endless/beginless) ranges, or excessively large ranges.
    def self.expand_range_to_enum(range)
      ...
      begin
        array = range.first(MAX_ENUM_RANGE_SIZE + 1)
      rescue TypeError
        return nil
      end

      return nil if array.empty? || array.size > MAX_ENUM_RANGE_SIZE
